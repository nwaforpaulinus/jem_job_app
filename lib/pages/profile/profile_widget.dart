                  ...
                  children: [
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.textController2 ??=
                                  TextEditingController(
                                text: listViewUsersRecord.skills,
                              ),
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: 'Skills*',
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => TextFormField(
                                controller: _model.textController5 ??=
                                    TextEditingController(
                                  text: listViewUsersRecord.description,
                                ),
                                obscureText: false,
                                decoration: InputDecoration(
                    ...
                    Stack(
                      children: [
                        ...
                        if (listViewUsersRecord.dateOfBirth != null)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 30.0, 0.0, 0.0),
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(
                                      dateTimeFormat('yMd',
                                          listViewUsersRecord.dateOfBirth!),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 65.0, 0.0, 20.0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          final usersUpdateData = createUsersRecordData(
                            displayName: _model.textController1.text,
                            skills: _model.textController2.text,
                            address: _model.textController3.text,
                            occupation: _model.textController4.text,
