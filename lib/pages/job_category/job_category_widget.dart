...
export 'job_category_model.dart';

class JobCategoryWidget extends StatefulWidget {
  const JobCategoryWidget({Key? key}) : super(key: key);

  @override
  _JobCategoryWidgetState createState() => _JobCategoryWidgetState();
}

class _JobCategoryWidgetState extends State<JobCategoryWidget> {
  late JobCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JobCategoryModel());
  }
